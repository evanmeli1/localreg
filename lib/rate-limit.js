...
export const RATE_LIMITS = {
  ...
  // /welcome verifies once per page load, so this is generous for a real
  // visitor reloading; it exists because the route spends a Stripe API call on
  // any string starting with "cs_".
  checkoutVerify: { limit: 30, windowMs: 60 * 60 * 1000 },
};
