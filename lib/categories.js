...
export const CATEGORIES = [
  ...
  },
  {
    ...
    tint: '#ECECEC',
    ink: '#5A5F66',
    // Empty by design: "Other" takes a free-text subcategory from the business
    // instead of a fixed list, so its chips are built from live data at runtime.
    subcategories: [],
    freeTextSubcategory: true,
  },
];

/** True when this category collects its subcategory as free text. */
export function usesFreeTextSubcategory(id) {
  return getCategory(id)?.freeTextSubcategory === true;
}
